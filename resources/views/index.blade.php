            ...
            <div class="col-lg-8">
                <article class="hentry post post-standard has-post-thumbnail sticky">
                    ...
                    <div class="post-thumb">
                        <img src="{{ $first_post->featured }}" alt="{{ $first_post->title }}" height="50px">
                        <div class="overlay"></div>
                        <a href="{{ $first_post->featured }}" height="50px" class="link-image js-zoom-image">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="offers">
                        <div class="row">
                            <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                                <div class="heading">
                                    <h4 class="h1 heading-title">{{ $js->name }}</h4>
                                    <div class="heading-line">
                                        <span class="short-line"></span>
                                        <span class="long-line"></span>
                                    </div>
                        ...
                        <div class="row">
                            <div class="case-item-wrap">
                                ...
                                @foreach($js->posts()->orderBy('created_at')->take(3)->get() as $post)
